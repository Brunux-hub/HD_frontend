...
const items = [
  { title: "Citas", url: "/veterinario/citas", icon: Calendar },
  { title: "Historial Médico", url: "/veterinario/historial-medico", icon: ClipboardList },
];
...
export default VeterinarioSidebar;